    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-5 py-16">
        ...
        <section className="mt-12">
          ...
          <div className="mt-4 rounded-lg border border-line bg-panel p-5 font-mono text-[13px] leading-relaxed">
              ...
              <tbody>
                {ENDPOINTS.map((e) => (
                  <tr key={e.route} className="border-b border-line align-top">
                    <td className="py-3 pr-4 font-mono text-fg">{e.route}</td>
                    <td className="py-3 pr-4 text-muted">{e.receives}</td>
                    <td className="py-3 pr-4 text-muted">{e.returns}</td>
                    <td className="py-3 font-mono text-ok">{e.keeps}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section className="mt-12">
          ...
          <pre className="mt-3 font-mono text-xs p-4 rounded-lg border border-line bg-panel leading-relaxed overflow-x-auto">
{`folder_selected
